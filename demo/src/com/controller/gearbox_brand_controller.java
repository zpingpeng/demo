...
import com.entity.gearbox_brand;
...
@zw_web
public class gearbox_brand_controller {
	zw_json json=new zw_json();
	
	@zw_path("/gearbox_brand_query")
	public String query(HttpServletRequest request,HttpServletResponse response){
		gearbox_brand vo=new gearbox_brand();
	...
	@zw_path("/gearbox_brand_synchronous")
