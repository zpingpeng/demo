...
import com.entity.chassis_brand;
...
@zw_web
public class chassis_brand_controller {
	zw_json json=new zw_json();
	
	@zw_path("/chassis_brand_query")
	public String query(HttpServletRequest request,HttpServletResponse response){
		chassis_brand vo=new chassis_brand();
	...
	@zw_path("/chassis_brand_synchronous")
