...
//			
	...
	@zw_path("/service_region_query")
	public String service_region(HttpServletRequest request,HttpServletResponse response){
		service vo=new service();
		
		jdbc_return return_jdbc=factory_class.jdbc_execute_sql(vo, static_class.jdbc_type_select,"select DISTINCT region from service");
		web_return return_object=new web_return("查询成功",return_jdbc.getList(),return_jdbc.getCount());
		return  json.toJsonString(return_object);
	}
