...
@zw_web
public class engin_brand_controller {
	zw_json json=new zw_json();
	
	@zw_path("/engin_brand_query")
	public String query(HttpServletRequest request,HttpServletResponse response){
		engin_brand vo=new engin_brand();
	...
	@zw_path("/engin_brand_synchronous")
